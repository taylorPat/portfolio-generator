...
DEFAULT_STATICS_FILE_FOLDER_PATH = Path().cwd() / "data" / "FE" / "static"
...
def build(
    ...
    copy_static(docs_folder_path=docs_folder_path, static_file_folder_path=static_files_folder_path)
